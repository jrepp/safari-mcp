...
export interface SafariExtractInput {
  kind: "element" | "query" | "style" | "accessibility" | "tables" | "meta" | "images" | "links" | "analyze" | "performance" | "css_coverage" | "layout" | "dom_tree" | "canvas" | "visual";
  selector?: string;
  ref?: string;
  refs?: string[];
  limit?: number;
  ...
  mode?: "scene_health" | "pixel_stats" | "threejs";
}
